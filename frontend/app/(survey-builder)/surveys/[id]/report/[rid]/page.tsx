          ...
          <div className="px-10 pt-8 pb-6">
            ...
            {grade && (
              <div className="mt-5 flex flex-wrap items-center gap-3 text-sm">
                <Stat label="Puntaje" value={`${grade.total} / ${grade.max}`} pal={pal} />
                <Stat label="Porcentaje" value={`${pct}%`} pal={pal} />
...
function QuestionBlock({
  ...
  const verdictMeta: Record<string, { label: string; bg: string; fg: string }> = {
    correct: { label: "Correcto", bg: "#dcfce7", fg: "#15803d" },
    partial: { label: "Parcial", bg: "#fef3c7", fg: "#b45309" },
    incorrect: { label: "Incorrecto", bg: "#fee2e2", fg: "#b91c1c" },
    ungraded: { label: "Sin corregir", bg: "#f1f5f9", fg: "#475569" },
  };
